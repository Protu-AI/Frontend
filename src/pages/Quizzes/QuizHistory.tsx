...
const DRAFT_QUIZZES: DraftQuiz[] = [
  ...
  {
    id: 'd3',
    title: 'Vue.js Components Deep Dive',
    topic: 'Vue.js',
...
export function QuizHistory() {
  const [activeFilter, setActiveFilter] = useState<'passed' | 'failed'>('passed');
  ...
  const getFilteredAndSortedQuizzes = () => {
    ...
    let filtered = PAST_QUIZZES.filter(quiz => quiz.status === activeFilter);
        ...
        <div className="flex gap-[48px] mb-[64px]">
          ...
          >
            ...
            <p className="font-['Archivo'] text-[48px] font-semibold text-[#FFBF00] text-left">
              {Math.round(PAST_QUIZZES.reduce((acc, quiz) => acc + quiz.score, 0) / PAST_QUIZZES.length)}%
            </p>
          </div>
          ...
          >
            ...
            <p className="font-['Archivo'] text-[48px] font-semibold text-[#52D999] text-left">
              {Math.round((PAST_QUIZZES.filter(quiz => quiz.status === 'passed').length / PAST_QUIZZES.length) * 100)}%
            </p>
          </div>
        </div>
        ...
        >
            ...
            <div className="flex items-center gap-[8px]">
              ...
              >
                ...
                {sortBy === 'date' && (
                  ...
                  >
                    {sortDirection === 'asc' ? (
                      <path d="M7 14L12 9L17 14" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"/>
                    ) : (
          ...
          <div className="space-y-[16px]">
            {filteredQuizzes.map((quiz) => (
              <div key={quiz.id} className="w-full p-[24px] rounded-[16px] border border-[#A6B5BB] flex justify-between items-center">
                  ...
                  <div className="flex items-center gap-[20px]">
                    ...
                    <div className="flex items-center gap-[8px] bg-[#EFE9FC] rounded-[16px] py-[4px] px-[12px]">
                      <svg 
                        ...
                        strokeWidth="2"
                      >
                        <rect x="3" y="4" width="18" height="18" rx="2" ry="2" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"/>
                        <line x1="16" y1="2" x2="16" y2="6" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"/>
                        <line x1="8" y1="2" x2="8" y2="6" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"/>
                        <line x1="3" y1="10" x2="21" y2="10" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"/>
                      </svg>
                      <span className="font-['Archivo'] text-[18px] font-medium text-[#1C0B43] text-left">
                        {quiz.date}
                      </span>
                ...
                <div className="flex items-center gap-[24px]">
                  ...
                  <div className="flex flex-col items-center">
                    <p className={`font-['Archivo'] text-[32px] font-semibold text-center mb-[2px] ${
                      quiz.status === 'passed' ? 'text-[#52D999]' : 'text-[#870056]'
                    }`}>
                      {quiz.score}%
                    </p>
                    <p className={`font-['Archivo'] text-[22px] font-semibold text-center ${
                      quiz.status === 'passed' ? 'text-[#52D999]' : 'text-[#870056]'
                    }`}>
                  ...
                  <button className="p-[12px] rounded-[16px] bg-[#EFE9FC] hover:bg-[#9F7CEC] transition-colors duration-200 group">
                    <svg 
                      ...
                      strokeWidth="2"
                    >
                      <path d="M1 12S5 4 12 4S23 12 23 12S19 20 12 20S1 12 1 12Z" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"/>
                  ...
                  <button className="p-[12px] rounded-[16px] bg-[#EFE9FC] hover:bg-[#9F7CEC] transition-colors duration-200 group">
                    <svg 
                      ...
                      strokeWidth="2"
                    >
                      <path d="M1 4V10H7" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"/>
                      <path d="M3.51 15A9 9 0 1 0 6 5L1 10" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                  </button>
                </div>
              </div>
          ...
          {showDrafts && (
            <>
              ...
              {/* Draft Quiz List */}
              <div className="space-y-[16px]">
                {DRAFT_QUIZZES.map((draft) => (
                  <div key={draft.id} className="w-full p-[24px] rounded-[16px] border border-[#A6B5BB] flex justify-between items-center">
                    {/* Left Side - Title and Tags */}
                    <div className="flex flex-col">
                      {/* Quiz Title */}
                      <h3 className="font-['Archivo'] text-[32px] font-medium text-[#1C0B43] text-left mb-[20px]">
                    ...
                    <div className="flex items-center gap-[24px]">
                      ...
                      <button className="p-[12px] rounded-[16px] bg-[#EFE9FC] hover:bg-[#9F7CEC] transition-colors duration-200 group">
                        <svg 
                          ...
                          strokeWidth="2"
                        >
                          <path d="M3 6H5H21" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round"/>
