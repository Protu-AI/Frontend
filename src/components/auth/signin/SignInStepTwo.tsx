import { useState } from 'react';
    ...
    export function SignInStepTwo({ email, onBack }: SignInStepTwoProps) {
            ...
            <div className="w-[420px] flex flex-col items-center">
              ...
              <div className="w-full">
                ...
                <Link
                  ...
                  onClick={onBack}
                >
                  <span className="text-[#A6B5BB] dark:text-[#EFE9FC] cursor-default font-normal">Not you? </span> 
                    Use another account
                </Link>
                ...
                <div className="w-full text-center mt-6 font-['Archivo'] text-base">
                  <span className="text-[#A6B5BB] dark:text-[#EFE9FC] pointer-events-none">Doesn't have an account? </span> 
                  <Link 
                    to="/signup" 
