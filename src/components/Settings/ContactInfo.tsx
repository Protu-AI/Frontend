  ...
  return (
    <>
          ...
          <div className="relative">
            ...
            <Dialog open={isOpen} onOpenChange={setIsOpen}>
              <DialogTrigger asChild>
                <button
                  className="absolute bottom-0 right-0 h-9 w-9 rounded-full bg-[#5F24E0] text-white shadow-md hover:bg-[#794ae9] flex items-center justify-center"
                >
                  <Pencil size={11} />
              ...
              >
                <DialogHeader>
                  ...
                  <DialogDescription style={{
                    ...
                    marginTop: '8px',
                    marginBottom: '64px'
                  }}>Show clients the best version of yourself!</DialogDescription>
                </DialogHeader>
                <div style={{
                  marginBottom: '24px',
                }}>
      ...
      <SettingsSection>
        ...
        <div className="grid grid-cols-2 gap-y-8" style={{ columnGap: '0px', rowGap: '32px' }}>
          <div style={gridItemStyle}>
            <div style={labelStyle}>First name</div>
            <div style={valueStyle}>Mahmoud</div>
          </div>
          <div style={gridItemStyle}>
            <div style={labelStyle}>Last name</div>
            <div style={valueStyle}>Elkholy</div>
          </div>
          <div style={gridItemStyle}>
          ...
          <div style={gridItemStyle}>
            ...
            <div style={valueStyle}>+201203709392</div>
          </div>
        </div>
      </SettingsSection>
      ...
      <SettingsSection>
        ...
        <div style={{...bioStyle, marginBottom: '32px'}}>
          Passionate programmer and tech enthusiast | Always learning, always coding | Specializing in Python, JavaScript, and AI development. Let’s build something amazing together!
        </div>
      </SettingsSection>
    </>
  );
